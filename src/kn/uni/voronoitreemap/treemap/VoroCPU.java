...
/**
 * Uses a CPU completely(all kernels) for calculation of the voronoi cells. As
 * soon as the queue is not empty it starts calculating.
 * 
 * @author Arlind Nocaj
 * 
 */
	...
	public void run() {
		while (true) {
			try {
				...
				System.out.println(voroNode.getNodeName());
				runningThreads.add(this);
				voroNode.iterate();
				tellEnd.finishedNode(voroNode.getNodeName(),
				        voroNode.getHeight(), voroNode.getChildrenNames(),
				        voroNode.getChildrenPolygons());
