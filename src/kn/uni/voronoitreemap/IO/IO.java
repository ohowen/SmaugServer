	...
	public static ArrayList<Tuple2ID> readWeights(String filename) throws Exception{
		...
		try{
			...
			while(reader.ready()){
				...
				Tuple2ID tuple = new Tuple2ID(name, value);
				data.add(tuple);
...
public static ArrayList<Tuple3ID> readRelativeVector(String filename) throws Exception{
		...
		try{
			...
			while(reader.ready()){
				...
				Tuple3ID tuple = new Tuple3ID(name, value1,value2);
				data.add(tuple);
	 ...
	 * @throws Exception
	 */
	public static ArrayList<ArrayList<String>> readTree(String filename) throws Exception {
		try{
			BufferedReader reader =new BufferedReader(new FileReader(filename));
			int n=0;
			String line="";
