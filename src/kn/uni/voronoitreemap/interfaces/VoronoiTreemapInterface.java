...
public interface VoronoiTreemapInterface {
	 ...
	 *            (list(a,b,c,d))
	 */
	public abstract void setTree(final ArrayList<ArrayList<String>> treeStructure);
...
//	public abstract void setNumberIterationsLevel(int[] levelsMaxIteration);
	...
	/**
	 * change datastructures2014.3.12 
	 */
	public abstract void setHashNode(VoroNode root);
	
	/**
	 * change 2014.3.26
	 */
	public abstract void setDisplayedRoot(VoroNode node);
}
